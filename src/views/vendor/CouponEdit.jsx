...
//         try {
//             await axios.get(`vendor-coupon-detail/${userData?.vendor_id}/${param.id}`).then((res) => {
//                 setCoupon(res.data);
//             })
//         } catch (error) {
...
//         await axios.patch(`vendor-coupon-detail/${userData?.vendor_id}/${param.id}/`, formdata).then((res) => {
